(function () {
  function setupCompactnessVorticesPlot() {
    const canvas = document.getElementById('compactnessVorticesCanvas');
    if (!canvas) return;
    const degreeInputs = document.querySelectorAll('input[name="compactness-vortices-degree"]');
  ...
  window.setupCompactnessVorticesPlot = setupCompactnessVorticesPlot;
})();
